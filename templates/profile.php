...
<center>
    ...
    <div style=" width: 320px; border-radius:6px; border: solid 1px black; background:#8B8682; align=center">
        <a href="/index.php?page=Profile_donates">Последние платежи</a>
    </div><br>
    <div style=" width: 320px; border-radius:6px; border: solid 1px black; background:#8B8682; align=center">
        <a href="/index.php?page=Profile_orders">Все покупки</a>
    </div><br>
    <div style=" width: 320px; border-radius:6px; border: solid 1px black; background:#8B8682; align=center">
        <a href="/index.php?page=Profile_items">Все товары</a>
    </div><br>
</center>
